...
```bash
ter params.nx first second --third "My Four"
...
[Syntax highlight for VS Code](https://marketplace.visualstudio.com/items?itemName=SaymonMacedo.nxlang)
> Created by Saymon Macedo.
> 
> [My alternative version](https://marketplace.visualstudio.com/items?itemName=marcoscode.nx)
...
Run `time ter speed.nx` and result:
```bash
Ok999999
real	0m2,632s
user	0m2,500s
